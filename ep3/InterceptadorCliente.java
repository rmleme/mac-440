// Classe: InterceptadorCliente.java
...
// Descricao: intercepta mensagens GIOP enviadas e recebidas pelo cliente.

import java.util.zip.*;

public class InterceptadorCliente implements jacorb.orb.ClientMessageInterceptor
{
  ...
  // Metodo: pre_invoke
  // Entrada: t: nao utilizada (so quando usa-se interceptacao per-object).
  //          buf: mensagem GIOP.
  // Saida: a mensagem GIOP comprimida.
  // Descricao: comprime a mensagem GIOP a ser enviada para o servidor.
  ...
  // Descricao: descomprime a mensagem GIOP recebida do servidor.
